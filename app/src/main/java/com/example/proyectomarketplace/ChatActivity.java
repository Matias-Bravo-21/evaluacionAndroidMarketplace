...
import com.example.proyectomarketplace.adapter.MensajeAdapter;
import com.example.proyectomarketplace.model.Mensaje;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void configurarCabecera() {
        ...
        tvNombreContacto.setText("Matias Bravo Vendedor MIllonario");
        tvEstadoContacto.setText("offline");
